...
def doCropping(theImage1,theImage2):
    ...
    if(size1[0]==size2[0] and size1[1]==size2[1]):
        ...
        if(scale0>scale1):
            print("scale0: {}\n".format(scale0))
            print("scale1: {}\n".format(scale1))
            res=cv2.resize(img2,(int(size2[1] * scale1), int(size2[0] * scale0)),interpolation=cv2.INTER_AREA)
        else:
            print(' Else' )
            print("scale0: {}\n".format(scale0))
            print("scale1: {}\n".format(scale1))
        ...
        if(scale0>scale1):
            print("scale0: {}\n".format(scale0))
            print("scale1: {}\n".format(scale1))
            res=cv2.resize(img1,(int(size1[1]*scale1), int(size1[0]*scale0)),interpolation=cv2.INTER_AREA)
        else:
            print("scale0: {}\n".format(scale0))
            print("scale1: {}\n".format(scale1))
            print(' 2nd Else')
...
def doCroppingHelp(img1,img2):
    size1=img1.shape
    size2=img2.shape
    print('size1 2: {}'.format(size1))
    print('size2 2: {}'.format(size2))
